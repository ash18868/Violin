...
public class HerobrineRenderer extends GeoEntityRenderer<HerobrineEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(HerobrineEntity animatable) {
        return new ResourceLocation(Violin.MOD_ID, "textures/entity/herobrine.png");
    }

    @Override
    public void render(HerobrineEntity entity, float entityYaw, float partialTick, PoseStack poseStack,
